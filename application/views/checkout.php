...
<div class="product-big-title-area" style="background-color: brown">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
...
<div class="container">
    <h3 align="center" id="order_review_heading">Pesanan Anda</h3>
                            ...
                            <div class="col-12">
                                <div class="woocommerce-billing-fields">
                                    ...
                                    <p id="billing_country_field" class="form-row form-row-wide address-field update_totals_on_change validate-required woocommerce-validated">
                                        <label class="" for="billing_country">Kota <abbr title="required" class="required">*</abbr>
                                        </label>
                                    ...
                                    <p id="billing_phone_field" class="form-row form-row-last validate-required validate-phone">
                                        <label class="" for="billing_phone">Nomor Telepon (08XXXXXXXXX)<abbr title="required" class="required">*</abbr>
                                        </label>
