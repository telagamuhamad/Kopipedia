                    ...
                    <ul>
                        ...
                        <?php
                            if(isset($_SESSION['email'])){
                                if(!$_SESSION['email'] == ''){
                                    ?>
                                    <li><a href="<?php echo base_url() ?>index.php/Cart/viewCart"><i class="fa fa-shopping-cart"></i> Keranjang</a></li>
                                    <?php
...
<div class="site-branding-area">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <div class="logo">
                    <h1><a href="<?php echo base_url() ?>index.php/Welcome">Kopi<span>Pedia</span></a></h1>
                </div>
            </div>
...
<div class="mainmenu-area" style="background-color: brown">
    <div class="container">
        <div class="row">
